...
Revision ID: b9875387aa7b
Revises: 
Create Date: 2020-08-11 22:49:12.309928
...
def upgrade():
    ...
    sa.Column('name', sa.Enum('pending', 'active', 'inactive', name='conteststatusenum'), nullable=False),
    ...
    sa.Column('status', sa.Enum('pending', 'active', 'inactive', name='conteststatusenum'), nullable=False),
