from .v1 import AvatarsAPI, AvatarsListAPI
from .v1 import ContestsAPI, ContestsListAPI, ContestsListCalendarAPI, ContestsMaterializedAPI, \
...
# Avatars
api.add_resource(AvatarsListAPI, '/contests/<uuid:uuid>/avatars', endpoint="avatars")
